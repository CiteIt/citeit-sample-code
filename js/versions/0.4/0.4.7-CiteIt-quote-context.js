...
// NOTE: CHANGE THIS URL TO MATCH YOUR DOMAIN 
// if you are self-hosting the JSON files
var json_read_base = "https://read.citeit.net/quote/";
    ...
    jQuery(this).each(function() {
        ...
        if (jQuery(this).attr("cite")) {
            ...
            if (cited_url.length > 3) {
                ...
                var read_url = json_read_base.concat("sha256/", webservice_version_num, "/",
